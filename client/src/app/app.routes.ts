...
export const routes: Routes = [
    ...
    {path:'user-profile', loadComponent: ()=> import('./pages/user-profile/user-profile.component')},
    {path:'user-display-profile', loadComponent: ()=> import('./pages/user-profile-display/user-profile-display.component')},   
];
